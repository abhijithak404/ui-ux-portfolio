...
export const Home: React.FC = () => {
  ...
  const homeProjects = JOB_PROJECTS.slice(0, 6);
  ...
  return (
    ...
    <main className="bg-white dark:bg-dark-950">
      ...
      {/* Professional Projects (Job Work) - 3-Column Grid */}
      <section id="professional-work" className="py-20 px-4 md:px-8 w-full border-t border-slate-200 dark:border-slate-800">
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {homeProjects.map((project, i) => (
              <motion.div
                ...
                className="group flex flex-col justify-between rounded-[2rem] bg-slate-50/70 dark:bg-slate-900/40 border border-slate-200/80 dark:border-slate-800/80 p-5 hover:border-slate-300 dark:hover:border-slate-700 transition-all duration-300 hover:shadow-xl dark:hover:shadow-2xl"
              >
                <div>
                  {/* Image Container */}
                  <Link
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover/img:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                      <span className="px-5 py-2.5 bg-white/20 backdrop-blur-md rounded-full text-white text-sm font-bold border border-white/30 transform translate-y-2 group-hover/img:translate-y-0 transition-transform duration-300">
                        View Case Study
                      </span>
                    </div>
                  </Link>
                ...
                <div className="flex justify-between items-center px-2 pt-6 mt-4 border-t border-slate-200/60 dark:border-slate-800/60">
                  <Link
                    to={`/professional-work/${project.id}`}
                    className="text-sm font-semibold text-slate-900 dark:text-white group-hover:underline flex items-center gap-1.5"
                  >
                    Case Study <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform" />
                  </Link>
                  <Link
                    to={`/professional-work/${project.id}`}
                    className="w-10 h-10 rounded-full border border-slate-200 dark:border-slate-800 flex items-center justify-center text-slate-900 dark:text-white group-hover:bg-slate-900 group-hover:text-white dark:group-hover:bg-white dark:group-hover:text-slate-900 transition-all duration-300"
                  >
          ...
          <div className="flex justify-center mt-14">
            <Link
              ...
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-slate-900 text-slate-900 dark:text-white font-bold text-sm uppercase tracking-wider transition-all duration-300 shadow-sm hover:shadow-xl group cursor-pointer"
            >
              <span>View All Professional Works</span>
